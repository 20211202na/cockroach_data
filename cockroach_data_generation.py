...
def drop_and_create():
    conn = psycopg2.connect('postgresql://test:test@127.0.0.1:26257/demo?sslmode=require')
...
def exe(list_of_ops, client_id):
    ...
    op_num = 0
    count = 0
    client_conn = psycopg2.connect("postgresql://test:test@127.0.0.1:26257/demo?sslmode=require")
